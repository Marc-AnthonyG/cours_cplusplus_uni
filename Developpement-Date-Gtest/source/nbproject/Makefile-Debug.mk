...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/TesteurDate.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -lgtest_main -lgtest -lpthread 


${TESTDIR}/TesteurDate.o: TesteurDate.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/TesteurDate.o TesteurDate.cpp
