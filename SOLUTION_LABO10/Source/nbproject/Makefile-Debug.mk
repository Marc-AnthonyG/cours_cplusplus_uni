...
${TESTDIR}/EmployeCommisTesteur.o: EmployeCommisTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/EmployeCommisTesteur.o EmployeCommisTesteur.cpp


${TESTDIR}/EmployeHoraireTesteur.o: EmployeHoraireTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/EmployeHoraireTesteur.o EmployeHoraireTesteur.cpp


${TESTDIR}/EmployeTesteur.o: EmployeTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/EmployeTesteur.o EmployeTesteur.cpp


${TESTDIR}/PatronTesteur.o: PatronTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/PatronTesteur.o PatronTesteur.cpp
