...
${OBJECTDIR}/Forme.o: Forme.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Forme.o Forme.cpp

${OBJECTDIR}/FormeDeuxDimensions.o: FormeDeuxDimensions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FormeDeuxDimensions.o FormeDeuxDimensions.cpp

${OBJECTDIR}/FormeTroisDimensions.o: FormeTroisDimensions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FormeTroisDimensions.o FormeTroisDimensions.cpp
...
${TESTDIR}/FormeTesteur.o: FormeTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/FormeTesteur.o FormeTesteur.cpp


${TESTDIR}/SphereTesteur.o: SphereTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/SphereTesteur.o SphereTesteur.cpp
...
${OBJECTDIR}/Cercle_nomain.o: ${OBJECTDIR}/Cercle.o Cercle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cercle_nomain.o Cercle.cpp;\
	else  \
...
${OBJECTDIR}/Forme_nomain.o: ${OBJECTDIR}/Forme.o Forme.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Forme_nomain.o Forme.cpp;\
	else  \
...
${OBJECTDIR}/FormeDeuxDimensions_nomain.o: ${OBJECTDIR}/FormeDeuxDimensions.o FormeDeuxDimensions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FormeDeuxDimensions_nomain.o FormeDeuxDimensions.cpp;\
	else  \
...
${OBJECTDIR}/FormeTroisDimensions_nomain.o: ${OBJECTDIR}/FormeTroisDimensions.o FormeTroisDimensions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FormeTroisDimensions_nomain.o FormeTroisDimensions.cpp;\
	else  \
...
${OBJECTDIR}/Sphere_nomain.o: ${OBJECTDIR}/Sphere.o Sphere.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sphere_nomain.o Sphere.cpp;\
	else  \
